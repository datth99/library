        ...
        <div class="col-lg-12">
          <form role="form" method="POST" action="student/{{ $student->id }}/update">
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="Nhập mật khẩu..." value="{{ $student->password }}">
                  @error('password')
                    <div class="text text-danger">{{ $message }}</div>
                  @enderror
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password_confirmation" placeholder="Xác nhận lại mật khẩu..."  value="{{ $student->password }}">
